...
void main() {
  const game1 = BoardSetting(3, 3, 3);
  ...
  test('small scores for small victories', () {
    var a = Score(1, game1, 1, const Duration(seconds: 7));
    var b = Score(1, game1, 1, const Duration(seconds: 10));
  ...
  test("super quick tic tac toe win doesn't beat an actually challenging win",
      () {
    var a = Score(1, game1, 1, const Duration(seconds: 3));
  ...
  test('bad performance is scored low (but non-zero)', () {
    var a = Score(1, game1, 1, const Duration(minutes: 10));
    var b = Score(1, game1, 1, const Duration(seconds: 10));
  ...
  test("extremely bad performance doesn't break the game", () {
    var a = Score(1, game1, 1, const Duration(days: 20000));
    var b = Score(1, game1, 1, const Duration(seconds: 10));
